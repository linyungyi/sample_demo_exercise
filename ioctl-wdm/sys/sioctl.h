...
#define IOCTL_SIOCTL_READ_REGISTER \
    CTL_CODE( SIOCTL_TYPE, 0xA00, METHOD_BUFFERED, FILE_ANY_ACCESS  )

#define IOCTL_SIOCTL_WRITE_REGISTER \
    CTL_CODE( SIOCTL_TYPE, 0xA01, METHOD_BUFFERED, FILE_ANY_ACCESS  )

#define IOCTL_SIOCTL_INTERRUPT \
    CTL_CODE( SIOCTL_TYPE, 0xA02, METHOD_BUFFERED, FILE_ANY_ACCESS  )

#define IOCTL_SIOCTL_BUFFERED \
    CTL_CODE( SIOCTL_TYPE, 0xA03, METHOD_BUFFERED, FILE_ANY_ACCESS  )
